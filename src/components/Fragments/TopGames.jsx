        ...
        <section id="top-games" className="top-games mt-10 md:mt-14 lg:mt-24">
            <div className="container mx-auto px-5 md:px-0 lg:px-32">
              ...
              <div className="card-best-seller flex justify-center flex-wrap mt-3 md:mt-6">
                <a className="m-[2.5px] lg:m-1" href="#">
                  <div className="card w-[9.6rem] h-[13rem] p-3 bg-white relative overflow-visible rounded-lg md:w-[15.2rem] md:h-[18.4rem] lg:w-[15rem] lg:h-[19.4rem]">
                    ...
                    <div className="card-info text-[0.6rem] md:text-[1rem]">
                      <p className="text-title">Minecraft</p>
                      <p className="text-body">200 Diamonds (160 + 40 Bonus)</p>
                    </div>
                ...
                <a className="m-[2.5px] lg:m-1" href="#">
                  <div className="card w-[9.6rem] h-[13rem] p-3 bg-white relative overflow-visible rounded-lg md:w-[15.2rem] md:h-[18.4rem] lg:w-[15rem] lg:h-[19.4rem]">
                    ...
                    <div className="card-info text-[0.6rem] md:text-[1rem]">
                      <p className="text-title">Redfall</p>
                      <p className="text-body">200 Diamonds (160 + 40 Bonus)</p>
                    </div>
                    <div className="card-footer flex justify-between items-center pt-2">
                      <span className="text-title text-[0.7rem] md:text-[1.1rem]">
                ...
                <a className="m-[2.5px] lg:m-1" href="#">
                  <div className="card w-[9.6rem] h-[13rem] p-3 bg-white relative overflow-visible rounded-lg md:w-[15.2rem] md:h-[18.4rem] lg:w-[15rem] lg:h-[19.4rem]">
                    ...
                    <div className="card-info text-[0.6rem] md:text-[1rem]">
                      <p className="text-title">Stronghold</p>
                      <p className="text-body">200 Diamonds (160 + 40 Bonus)</p>
                    </div>
                    <div className="card-footer flex justify-between items-center pt-2">
                      <span className="text-title text-[0.7rem] md:text-[1.1rem]">
                ...
                <a className="m-[2.5px] lg:m-1" href="#">
                  <div className="card w-[9.6rem] h-[13rem] p-3 bg-white relative overflow-visible rounded-lg md:w-[15.2rem] md:h-[18.4rem] lg:w-[15rem] lg:h-[19.4rem]">
                    ...
                    <div className="card-info text-[0.6rem] md:text-[1rem]">
                      <p className="text-title">Eidolon</p>
                      <p className="text-body">200 Diamonds (160 + 40 Bonus)</p>
                    </div>
                    <div className="card-footer flex justify-between items-center pt-2">
                      <span className="text-title text-[0.7rem] md:text-[1.1rem]">
                ...
                <a className="m-[2.5px] lg:m-1" href="#">
                  <div className="card w-[9.6rem] h-[13rem] p-3 bg-white relative overflow-visible rounded-lg md:w-[15.2rem] md:h-[18.4rem] lg:w-[15rem] lg:h-[19.4rem]">
                    <div className="card-img w-[100%] h-[50%] overflow-hidden md:w-[100%] md:h-[50%]">
                      <img src={Serinfate} alt="" />
                    </div>
                    <div className="card-info text-[0.6rem] md:text-[1rem]">
                      <p className="text-title">Serinfate</p>
                      <p className="text-body">200 Diamonds (160 + 40 Bonus)</p>
                    </div>
                    <div className="card-footer flex justify-between items-center pt-2">
                      <span className="text-title text-[0.7rem] md:text-[1.1rem]">
                ...
                <a className="m-[2.5px] lg:m-1" href="#">
                  <div className="card w-[9.6rem] h-[13rem] p-3 bg-white relative overflow-visible rounded-lg md:w-[15.2rem] md:h-[18.4rem] lg:w-[15rem] lg:h-[19.4rem]">
                    <div className="card-img w-[100%] h-[50%] overflow-hidden md:w-[100%] md:h-[50%]">
                      <img src={Surviving} alt="" />
                    </div>
                    <div className="card-info text-[0.6rem] md:text-[1rem]">
                      <p className="text-title">Surviving</p>
                      <p className="text-body">200 Diamonds (160 + 40 Bonus)</p>
                    </div>
                    <div className="card-footer flex justify-between items-center pt-2">
                      <span className="text-title text-[0.7rem] md:text-[1.1rem]">
                ...
                <a className="m-[2.5px] lg:m-1" href="#">
                  <div className="card w-[9.6rem] h-[13rem] p-3 bg-white relative overflow-visible rounded-lg md:w-[15.2rem] md:h-[18.4rem] lg:w-[15rem] lg:h-[19.4rem]">
                    ...
                    <div className="card-info text-[0.6rem] md:text-[1rem]">
                      <p className="text-title">Magicka</p>
                      <p className="text-body">200 Diamonds (160 + 40 Bonus)</p>
                    </div>
                    <div className="card-footer flex justify-between items-center pt-2">
                      <span className="text-title text-[0.7rem] md:text-[1.1rem]">
                ...
                <a className="m-[2.5px] lg:m-1" href="#">
                  <div className="card w-[9.6rem] h-[13rem] p-3 bg-white relative overflow-visible rounded-lg md:w-[15.2rem] md:h-[18.4rem] lg:w-[15rem] lg:h-[19.4rem]">
                    <div className="card-img w-[100%] h-[50%] overflow-hidden md:w-[100%] md:h-[50%]">
                      <img src={Halfpast} alt="" />
                    </div>
                    <div className="card-info text-[0.6rem] md:text-[1rem]">
                      <p className="text-title">Half Past Fate</p>
                      <p className="text-body">200 Diamonds (160 + 40 Bonus)</p>
                    </div>
                    <div className="card-footer flex justify-between items-center pt-2">
                      <span className="text-title text-[0.7rem] md:text-[1.1rem]">
                ...
                <a className="m-[2.5px] lg:m-1" href="#">
                  <div className="card w-[9.6rem] h-[13rem] p-3 bg-white relative overflow-visible rounded-lg md:w-[15.2rem] md:h-[18.4rem] lg:w-[15rem] lg:h-[19.4rem]">
                    ...
                    <div className="card-info text-[0.6rem] md:text-[1rem]">
                      <p className="text-title">Papo & Yo</p>
                      <p className="text-body">200 Diamonds (160 + 40 Bonus)</p>
                    </div>
                    <div className="card-footer flex justify-between items-center pt-2">
                      <span className="text-title text-[0.7rem] md:text-[1.1rem]">
                ...
                <a className="m-[2.5px] lg:m-1" href="#">
                  <div className="card w-[9.6rem] h-[13rem] p-3 bg-white relative overflow-visible rounded-lg md:w-[15.2rem] md:h-[18.4rem] lg:w-[15rem] lg:h-[19.4rem]">
                    ...
                    <div className="card-info text-[0.6rem] md:text-[1rem]">
                      <p className="text-title">Endless Legend</p>
                      <p className="text-body">200 Diamonds (160 + 40 Bonus)</p>
                    </div>
                    <div className="card-footer flex justify-between items-center pt-2">
                      <span className="text-title text-[0.7rem] md:text-[1.1rem]">
